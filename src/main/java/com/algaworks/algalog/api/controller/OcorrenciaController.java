...
public class OcorrenciaController {
	...
	public OcorrenciaModel registrar(@PathVariable Long entregaId, 
			@Valid @RequestBody OcorrenciaInputModel inputModel ) {
		
		Ocorrencia ocorrenciaRegistrada = registroOcorrenciaService.registrar(entregaId, inputModel.getDescricao());
